<div class="bg-stone-50 rounded-lg border-2 shadow-lg border-stone-200 dark:border-gray-600 flex items-center justify-center h-[40%]">
    <div class="p-4 bg-stone-50 rounded-lg dark:border-red-700">
    ...
    <p class="font-medium text-lg leading-6 mt-3 text-center">BEST RECORD</p>
